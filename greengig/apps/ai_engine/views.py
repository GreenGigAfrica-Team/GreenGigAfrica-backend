...
GET /api/v1/ai/match/  — return AI-matched tasks for the current user
"""
...
def matched_tasks(request):
    """
    Return AI-matched task recommendations for the authenticated job seeker.
    """
    try:
        profile = request.user.job_seeker_profile
    except JobSeekerProfile.DoesNotExist:
        return Response(
            {"detail": "Complete your profile to get task recommendations."},
